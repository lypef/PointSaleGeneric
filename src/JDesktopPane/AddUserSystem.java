 ...
 * @author lypef
 */
public class AddUserSystem extends javax.swing.JInternalFrame {

    /**
     * Creates new form AddUserSystem
     */
    String Level;
    public AddUserSystem(String LevelTmp) {
        Level = LevelTmp;
        initComponents();
        LoadComboBoxLevel();
    }
    ...
    private void initComponents() {
        ...
        jLabel19.setText("Ingrese los datos del nuevo usuario");
    ...
    private void AddValuesUser() 
    {
        try {
            ...
            String insert = "INSERT INTO usuarios(usuario, contraseña, nombre, PrimerApellido, SegundoApellido, Direccion, Telefono, CorreoElectronico, Nivel) VALUES ('"+TxtUsername.getText().replace(" ", "")+"', '"+TxtPasswors.getText()+"', '"+TxtName.getText()+"', '"+TxtFirstLastname.getText()+"', '"+ SecundLAstname.getText()+"', '"+TxtDireccion.getText()+"', '"+TxtTel.getText()+"', '"+TxtMail.getText()+"', '"+ComboBoxLevel.getSelectedItem().toString().toLowerCase()+"'  )";
